...
/* SYSCALLS FOR DEBUGGER */
extern int become_debugger();
extern int set_breakpoint(void *addr);
extern int remove_breakpoint(void *addr);
extern int enable_breakpoint(void *addr);
extern int disable_breakpoint(void *addr);
